...
class NewChatMessageFieldView: NSView, LoadableNib {
    ...
    @IBOutlet weak var childViewControllerContainer: ChatMenuListView!
    @IBOutlet weak var newChatAttachmentView: NewChatAttachmentView!
    ...
    func updateBottomBarHeight() -> Bool {
        ...
        let attachmentHeight: CGFloat = (newChatAttachmentView?.isHidden ?? false) ? 0 : 180
        let newFieldHeight = min(updatedHeight, kTextViewLineHeight * 11) + 12 + attachmentHeight
    ...
    @IBAction func attachmentsButtonClicked(_ sender: Any) {
        childViewControllerContainer.isHidden = false
    }
