//
//  NewChatMessageFieldView+FieldsExtension.swift
//  Sphinx
//
...
extension NewChatMessageFieldView : NSTextViewDelegate, MessageFieldDelegate {
    func textView(
...
extension NewChatMessageFieldView : NSTextFieldDelegate {
