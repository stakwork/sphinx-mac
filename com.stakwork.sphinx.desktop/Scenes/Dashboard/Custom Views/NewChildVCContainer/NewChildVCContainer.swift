...
class NewChildVCContainer: NSView, LoadableNib {
    ...
    let menuSize = CGSize(width: 136, height: 152)
...
//        notificationLevelView.isHidden = true
    ...
    func showPaymentModeWith(
        ...
        with chat: Chat?,
        delegate: ActionsDelegate,
        mode: NewChildVCContainer.ChildVCOptionsMenuButton
    ) {
        switch (mode) {
...
extension NewChildVCContainer : ChildVCDelegate {
...
extension NewChildVCContainer : TribeMemberPopupViewDelegate {
