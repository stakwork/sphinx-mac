...
class TribeMembersViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        tribeMembersCollectionView.layer?.backgroundColor = NSColor.Sphinx.Body.cgColor
        tribeMembersCollectionView.setBackgroundColor(color: NSColor.Sphinx.Body)
...
//        loadTribeContacts()
    ...
    func loadTribeContacts() {
        print("I am here with chat id: \(self.chat.id)")
...
//            let contacts = self.getGroupContactsFrom(contacts: c)
//            self.groupContacts.append(contentsOf: contacts)
//            self.groupPendingContacts.append(contentsOf: pendingContacts) = pendingContacts
//            print("I am here with group list: \(self.groupContacts.count) -> \(self.groupContacts)")
...
//        groupContacts.append(contentsOf: groupPendingContacts)
//        print("I am here with group list: \(groupContacts.count) -> \(groupContacts[0])")
//        print("I am here with group list: \(groupPendingContacts.count) -> \(groupPendingContacts[0])")
        return (groupContacts, groupPendingContacts)
    }
    
    func getGroupContactsFrom(contacts: [UserContact]) -> [GroupContact] {
        print("I am here with group list: \(contacts.count) -> \(contacts)")
        print("I am here with chat list: \(chat)")
    ...
    func loadGroupContacts() {
        ...
        print("I am here with group list: \(groupContacts.count) -> \(groupContacts)")
        print("I am here with group list: \(groupPendingContacts.count) -> \(groupPendingContacts)")
//        self.tableView.reloadData()
//        self.messageBubbleHelper.hideLoadingWheel()
    }
}
